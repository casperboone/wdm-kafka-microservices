...
public class PaymentController {
    ...
    public CompletableFuture<Payment> addPayment(@PathVariable(value = "userId") UUID userId, @PathVariable(value = "orderId") UUID orderId, @PathVariable(value = "amount") int amount) {
    ...
    public CompletableFuture<Payment> deletePayment(@PathVariable(value = "userId") UUID userId, @PathVariable(value = "orderId") UUID orderId) {
