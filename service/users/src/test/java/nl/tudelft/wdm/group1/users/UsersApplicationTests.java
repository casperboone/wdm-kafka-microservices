...
public class UsersApplicationTests {
    ...
    public void createNewUser() throws Exception {
        ...
        await().until(() -> userRepository.contains(result.getId()));

        User user = userRepository.find(result.getId());
    ...
    public void addCredit() {
        ...
        await().untilAsserted(() -> assertThat(defaultUser.getCredit()).isEqualTo(3749));
    }
