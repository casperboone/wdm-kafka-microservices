...
Experimental Kafka-backed microservice architecture for performance evaluation. The project consists out of 5 microservices simulating the major components of a webshop.
The [REST](https://github.com/casperboone/wdm-kafka-microservices/tree/master/service/rest) service handles all incoming requests and transforms these into messages that are pushed to Kafka.
